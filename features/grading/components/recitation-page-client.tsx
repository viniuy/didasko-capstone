...
interface RecitationPageClientProps {
  course: Course;
  initialStudents?: Student[];
  initialRecitationCriteria?: Criteria[];
}

export function RecitationPageClient({
  course,
  initialStudents = [],
  initialRecitationCriteria = [],
}: RecitationPageClientProps) {
          ...
          <div className="flex flex-col flex-grow px-4">
            ...
            <div className="flex-1 overflow-y-auto pb-6">
              <GradingTable
                ...
                initialRecitationCriteria={initialRecitationCriteria}
              />
            </div>
          </div>
